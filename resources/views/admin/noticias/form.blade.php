    ...
    <div class="card-body">
        ...
        {{Form::token()}}
            ...
            <div class="form-group has-success">
                ...
                <input name="not_sub_titulo" placeholder="Sub Titulo de la noticia" id="cc-name" name="not_sub_titulo" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error">
